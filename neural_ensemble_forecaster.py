...
class neural_ensemble_forecaster(object):
    ...
    def eveluate_output_pdf(self,
        ...
        for output_matrix in output_matrices:
            ...
            matrix_index += 1
        #print "the number of active weights is " + str(active_weights_count) + " on a total of " + str(weights_count) + " weights."
    ...
    def visualize_forecast(self, 
                           ...
                           **kwargs):
        ## private functions ##
        def get_forecast(data, target_time, output_range):
            ...
            return pdf_array
        ## main code ##
        forecast = get_forecast(data, target_time, output_range)
        ...
        plt.plot(data_time, data.flatten(), color = "k", lw = 2)
